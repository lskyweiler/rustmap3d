...
// 
//     let n: f64 =
//         EARTH_SEMI_MAJOR_AXIS / f64::sqrt(1.0 - _ECEF2LLA_E2 * f64::powf(f64::sin(lat_rad), 2.0));
//     let x_ecef: f64 = (n + alt) * f64::cos(lat_rad) * f64::cos(lon_rad);
//     let y_ecef: f64 = (n + alt) * f64::cos(lat_rad) * f64::sin(lon_rad);
//     let z_ecef: f64 = ((1.0 - _ECEF2LLA_E2) * n + alt) * f64::sin(lat_rad);
